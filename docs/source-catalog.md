...
当前目录共 22 条：11 active、11 candidate、0 paused。数量是目录基线；用户暂停或人工激活后，数据库运行状态可以不同。Feed/RSSHub/sitemap/公开数据优先级与逐来源证据见 [`source-acquisition-review.md`](source-acquisition-review.md)。
